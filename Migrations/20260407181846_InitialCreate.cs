    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Workers_Hostels_HostelId",
                        column: x => x.HostelId,
                        principalTable: "Hostels",
                        principalColumn: "HostelId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CleaningRecords", x => x.RecordId);
                    table.ForeignKey(
                        name: "FK_CleaningRecords_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "RoomId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CleaningRecords_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_HostelId_Email",
                table: "AspNetUsers",
                columns: new[] { "HostelId", "Email" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CleaningRecords_RoomId_Date",
                table: "CleaningRecords",
                columns: new[] { "RoomId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_CleaningRecords_WorkerId",
                table: "CleaningRecords",
                column: "WorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_Complaints_HostelId_Status",
                table: "Complaints",
                columns: new[] { "HostelId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_HostelId_RollNumber",
                table: "Students",
                columns: new[] { "HostelId", "RollNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workers_HostelId_Department",
                table: "Workers",
                columns: new[] { "HostelId", "Department" });
